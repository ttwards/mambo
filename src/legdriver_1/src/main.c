...
int main(void) 
{
  ...
  motor_set_mode(motor1, PV);  k_sleep(K_MSEC(1));
  motor_set_mode(motor2, PV);  k_sleep(K_MSEC(1));
  motor_set_mode(motor3, PV);  k_sleep(K_MSEC(1));
  motor_set_mode(motor4, PV);  k_sleep(K_MSEC(10));
  motor_set_mode(motor5, PV);  k_sleep(K_MSEC(1));
  motor_set_mode(motor6, PV);  k_sleep(K_MSEC(1));
  motor_set_mode(motor7, PV);  k_sleep(K_MSEC(10));
  motor_set_mode(motor8, PV);
